...
# Ensure the models are loaded properly
if xgb_regressor is None:
    st.error("Failed to load the XGBRegressor model.")
if label_encoder is None:
    st.error("Failed to load the label encoder.")
if scaler is None:
    st.error("Failed to load the scaler.")
...
if info:
    ...
    if xgb_regressor:
        ...
        st.error("Model is not available. Cannot make predictions.")
